...
import pygame
import esper
from src.create.prefabs_create import create_bullet, create_enemy_spawner, create_input_player, create_player_square
...
from src.ecs.systems.s_player_state import sustem_player_state
...
class GameEngine:
    ...
    def _update(self):
        ...
        sustem_player_state(self.ecs_world)
